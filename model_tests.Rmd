...
des.cosine = generateDesign(des.n, par.set = getParamSet(fun.cosine), des.fun)
...
model_1 = generate_model(fun.cosine, des.cosine, surr.km, 
                         control.iters=10, control.crit=makeMBOInfillCritEI())

# optional: define multi_iters here. default is c(1L, 2L, 10L)

run_1 = run_model(obj.fun=model_1$obj.fun, design=model_1$des, learner=model_1$learner,
                  control=model_1$control, multi_iters=10L)
...
model_2 = generate_model(fun.cosine, des.cosine, surr.km,
                         control.iters=10, control.crit=makeMBOInfillCritCB())


# optional: define multi_iters here. default is c(1L, 2L, 10L)
run_2 = run_model(obj.fun=model_2$obj.fun, design=model_2$des, learner=model_2$learner, 
                  control=model_2$control, multi_iters=10L)
...
```{r}
model_3 = generate_model(fun.cosine, des.cosine, surr.km,
                         control.iters=10, control.crit=makeMBOInfillCritAEI())

# optional: define multi_iters here. default is c(1L, 2L, 10L)
run_3 = run_model(obj.fun=model_3$obj.fun, design=model_3$des, learner=model_3$learner, 
                  control=model_3$control, multi_iters=10L)
