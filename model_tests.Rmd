...
run_1 = run_model(model=model_1, multi_iters=10L)
...
# optional: define multi_iters here. default is c(1L, 2L, 10L)
run_2 = run_model(model=model_2, multi_iters=10L)
...
# optional: define multi_iters here. default is c(1L, 2L, 10L)
run_3 = run_model(model=model_3, multi_iters=10L)
...
run_4 = run_model(model=model_4, multi_iters=10L)
...
model_5 = generate_model(fun.cosine, des.cosine_random, surr.km,
                         control.iters=10, control.crit=makeMBOInfillCritCB())


# optional: define multi_iters here. default is c(1L, 2L, 10L)
run_5 = run_model(model=model_5, multi_iters=10L)
